...
function caja() {
    const datosCompras = [
        ...
        { cantidad: 1, producto: "Teclado ARGOM Inalambrico", codigo: "/", departamento: "CAJA", responsable: "CLAUDIA FLORES " },
    ...
    contVolver.className = "caja-cont-volver";
    section.appendChild(contVolver);
    
    let botonVolver = document.createElement('button');
    botonVolver.textContent = "Volver";
    botonVolver.className = "caja-boton-volver";
