...
function caja() {
    const datosGuardados = localStorage.getItem('cajaEditados');
    const datosCaja = datosGuardados ? JSON.parse(datosGuardados) : [
        { cantidad: 1, producto: "CPU HP PRODESK 400 G3 MT CORE i5-6500 @ 3.20GHz RAM 8GB", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "MONITOR HP 19", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "IMPRESORA TÉRMICA BIXOLON", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "IMPRESORA HP LASERJET P2035", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "LECTOR DE CÓDIGO DE BARRAS HONEYWELL", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "CAJÓN DE DINERO", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
        { cantidad: 1, producto: "UPS APC", codigo: "/", departamento: "CAJA", responsable: "MAYRA FERNANDEZ" },
    ];
    ...
    if (usuario && (usuario.rol === 'editor' || usuario.rol === 'admin')) {
        ...
        function guardarCambios() {
            ...
            localStorage.setItem('cajaEditados', JSON.stringify(nuevosDatos));
            return nuevosDatos;
        }
        ...
        if (usuario.rol === 'admin') {
            ...
            botonAgregar.addEventListener('click', () => {
                ...
                [1, "Nuevo Producto", "/", "CAJA", ""].forEach(text => {
                    const td = document.createElement('td');
                    td.textContent = text;
            ...
            botonRestaurar.addEventListener('click', () => {
                if (confirm('¿Restaurar datos originales?')) {
                    localStorage.removeItem('cajaEditados');
                    document.getElementById('root').innerHTML = "";
