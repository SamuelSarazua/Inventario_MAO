...
function carritoPrimaElemn() {
    const datosGuardados = localStorage.getItem('carritoIpadPrimariaElementalEditados');
    ...
    if (usuario && (usuario.rol === 'editor' || usuario.rol === 'admin')) {
        ...
        function guardarCambios() {
            ...
            localStorage.setItem('carritoIpadPrimariaElementalEditados', JSON.stringify(nuevosDatos));
            return nuevosDatos;
        }
        ...
        if (usuario.rol === 'admin') {
            ...
            botonAgregar.addEventListener('click', () => {
                ...
                [1, "Nuevo Producto", "", "", "", "CARRITO DE IPAD COORDINACIÓN DE PRIMARIA ELEMENTAL"].forEach(text => {
                    const td = document.createElement('td');
                    td.textContent = text;
            ...
            botonRestaurar.addEventListener('click', () => {
                if (confirm('¿Restaurar datos originales?')) {
                    localStorage.removeItem('carritoIpadPrimariaElementalEditados');
                    document.getElementById('root').innerHTML = "";
                    document.getElementById('root').appendChild(carritoPrimaElemn());
                }
            });
        }
